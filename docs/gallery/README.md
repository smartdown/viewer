...
- **0.0.98** - Fix ESLint errors. Better handling of position:relative disclosable tooltip override; Inhibit window scrolling when tooltip is relative. Factor out much of the extension-specific initialization and handling into separate source files.
