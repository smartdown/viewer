...
/* WEBPACK VAR INJECTION */(function(process, global) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
    ...
    if (lowerhref.indexOf(smartdownTag) === 0) {
      ...
      if (op === 'INPUT') {
        ...
        if (rhs === null) {
          ...
          newHTML += "<a\n                    id=\"trigger_".concat(lhs, "\"\n                    class=\"a-disclosable\"\n                    onmouseover=\"smartdown.activatePopup('").concat(lhs, "', 'popup');\"\n                    onmouseout=\"smartdown.deactivatePopup('").concat(lhs, "', 'popup');\">").concat(body, "</a>");
        }
      }
  ...
  function activatePopup(divId) {
    var div = document.getElementById(divId);
    var trigger = document.getElementById("trigger_".concat(divId));
    div.style.position = 'absolute';
    div.style.top = "".concat(trigger.offsetTop + trigger.offsetHeight, "px");
    var padding = 20;
    div.style.padding = "".concat(padding, "px ").concat(padding, "px");
    var popupWidth = Math.floor(window.innerWidth / 3) + 2 * padding;

    if (trigger.offsetLeft + popupWidth < window.innerWidth) {
      div.style.left = "".concat(trigger.offsetLeft, "px");
    } else {
      var popupLeft = trigger.offsetLeft + trigger.offsetWidth - popupWidth;
      div.style.left = "".concat(popupLeft, "px");
    }
...
//# sourceMappingURL=smartdown.2030d8777f5cd64ca50a.hot-update.js.map